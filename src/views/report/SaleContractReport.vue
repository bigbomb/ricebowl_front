  ...
  <el-row id="spotstock">
    ...
    <el-col>
      ...
      >
        ...
        <el-table-column property="customername" label="客户名称" width="250">
          <template slot-scope="scope">
            <span>{{ scope.row.customername }}</span>
          </template>
        </el-table-column>
        <el-table-column property="finalweight" label="客户结算重量(吨)" width="140">
          <template slot-scope="scope">
            <span>{{ scope.row.finalweight }}</span>
          </template>
        </el-table-column>
        <el-table-column property="finalamount" label="客户结算金额(元)" width="160">
          <template slot-scope="scope">
            <span>{{ scope.row.finalamount }}</span>
          </template>
        </el-table-column>
        <el-table-column property="actualweight" label="采购总吨位(吨)" width="160">
          <template slot-scope="scope">
            <span>{{ scope.row.actualweight }}</span>
          </template>
        </el-table-column>
        <el-table-column property="actualamount" label="采购总金额(元)" width="160">
          <template slot-scope="scope">
        ...
        <el-table-column property="stockouttotalfee" label="出库费(元)" width="100">
          <template slot-scope="scope">
            <!-- <el-input size="mini" v-model="scope.row.num" placeholder="请输入内容"></el-input> -->

<template>
  <el-row class="container">
    <el-col :span="24" class="header">
      ...
      <el-col :span="4" class="userinfo">
        <el-dropdown trigger="hover">
          <span class="el-dropdown-link userinfo-inner">欢迎您,{{nickName}}</span>
      ...
      <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
        ...
        <transition name="el-fade-in">
          <el-menu
            ...
            class="el-menu-vertical-demo el-menu-vertical-demo-main"
            style="width: 100%"
            @open="handleopen"
            @close="handleclose"
            @select="handleselect"
          ...
          >
            <template v-for="(item,index) in rolePermis" v-if="item.children.length > 0">
              ...
              <el-menu-item
                v-if="item.url!='/' && item.children.length>0"
        ...
        <el-collapse-transition>
          ...
          >
            <li
              v-for="(item,index) in rolePermis"
              ...
              <template v-if="true">
                ...
                >
                  <li
                    ...
                    :class="$route.path==child.url?'is-active':''"
    ...
    <el-col>
      <el-dialog title="编辑个人信息" :visible.sync="dialogVisible" width="25%">
        <div>
          <el-form
            :inline="true"
            :model="userform"
  ...
  methods: {
    ...
    logout: function() {
      ...
      this.$confirm("确认退出吗?", "提示", {
        ...
        .then(() => {
          this.axios
            .post(process.env.API_ROOT + "/LoginApi/v1/loginOut")
            .then(response => {
              if (response.data.status === 200) {
                _this.$cookie.set("user", null, -1);
    ...
    async editUserInfo() {
      ...
      // 		}
      // 		let data = this.axios.post(process.env.API_ROOT +'/UserApi/v1/editUserInfo', params)
    ...
    initUserInfo() {
      let _this = this;
      var usr = JSON.parse(_this.$cookie.get("user"));
      if (usr) {
        this.nickName = usr.userName;
        this.rolePermis = JSON.parse(window.localStorage.getItem("rolePermis"));

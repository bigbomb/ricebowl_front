  ...
  methods: {
    ...
    async getUserLoginTotal() {
      ...
      let data = this.axios.get(
        process.env.API_ROOT + "SysApi/v1/findUserLoginTotal"
      );
    ...
    async getUserReqTotal() {
      let _this = this;
      let data = this.axios.get(
        process.env.API_ROOT + "SysApi/v1/findUserReqTotal"
      );
    ...
    drawColumnChart() {
      var userLoginTotal = echarts.init(
        document.getElementById("userLoginTotale")
      );

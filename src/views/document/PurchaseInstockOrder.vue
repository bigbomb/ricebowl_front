    ...
    <el-col>
      ...
      >
        ...
        <el-table-column
          ...
          v-if="isshow"
        ></el-table-column>
        <el-table-column prop="purchasestatus" label="入库单状态" fixed="left" sortable width="150"></el-table-column>
...
export default {
  ...
  computed: {
    addShow() {
      return this.getHasRule("新增采购入库单");
    },
    delShow() {
      return this.getHasRule("删除采购入库单");
    },
    findShow() {
    ...
    copyShow() {
      return this.getHasRule("复制采购入库单");
    }
  }
};
</script>

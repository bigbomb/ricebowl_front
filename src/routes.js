...
import TransportOrder from './views/document/TransportOrder.vue'
...
let router = [
  ...
  },
  {
    ...
    children: [
      {
        path: '/purchaseInstockInvoiceList',
        component: PurchaseInvoice,
        name: '采购发票'
      },
      {
        path: '/SaleContractInvoiceList',
        component: SalesInvoice,
        name: '销售合同发票'
      },
      {
        path: '/SaleContractAnalyseList',
        component: SalesAnalyse,
        name: '销售分析'
      }
    ]
  },
